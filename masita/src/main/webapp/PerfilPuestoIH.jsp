            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <form class="navbar-form navbar-right">
                        <button type="submit" class="btn btn-warning">Reg&iacutestrate</button>
                        <button type="submit" class="btn btn-success">Iniciar Sesi&oacuten</button>
                    </form>
                </div>
            </div>
        </nav>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Est&aacuten sucias las mesas</td>
                            <td><img src="images/3star-rating.gif" height="40"> </td>
                            <td>15 Sep, 8:56 AM</td>
                        </tr>
                    </tbody>
